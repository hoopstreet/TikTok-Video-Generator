export const PHILIPPINES_VOICES = [
  { id: 'fish-ate-budol', name: 'Ate (Fish: Realistic Taglish)', lang: 'fil-PH', engine: 'fish-speech' },
  { id: 'fish-kuya-tech', name: 'Kuya (Fish: Energetic Pinoy)', lang: 'fil-PH', engine: 'fish-speech' },
